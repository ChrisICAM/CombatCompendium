...
public final class UserSampleBinding implements ViewBinding {
  ...
  private UserSampleBinding(@NonNull ConstraintLayout rootView, @NonNull Switch followSwitch,
  ...
  public static UserSampleBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.followSwitch;
      Switch followSwitch = ViewBindings.findChildViewById(rootView, id);
      ...
      return new UserSampleBinding((ConstraintLayout) rootView, followSwitch, profilePic, username);
    }

...
public final class PopupBinding implements ViewBinding {
  ...
  private PopupBinding(@NonNull ConstraintLayout rootView, @NonNull Button cancel,
      @NonNull EditText editText, @NonNull Button submit, @NonNull TextView title) {
  ...
  public static PopupBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new PopupBinding((ConstraintLayout) rootView, cancel, editText, submit, title);
    }

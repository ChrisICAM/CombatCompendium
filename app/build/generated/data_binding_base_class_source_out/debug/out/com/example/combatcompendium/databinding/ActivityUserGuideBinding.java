...
public final class ActivityUserGuideBinding implements ViewBinding {
  ...
  private ActivityUserGuideBinding(@NonNull ConstraintLayout rootView, @NonNull WebView webView) {
  ...
  public static ActivityUserGuideBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityUserGuideBinding((ConstraintLayout) rootView, webView);
    }
